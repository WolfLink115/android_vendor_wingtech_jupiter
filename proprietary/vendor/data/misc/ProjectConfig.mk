...
CUSTOM_HAL_LENS = dish_cn3927af
CUSTOM_HAL_IMGSENSOR = dish_main_txd_hi1634b_mipi_raw dish_front_st_hi846_mipi_raw dish_depth_cxt_bf2253_mipi_raw dish_wide_cxt_gc5035_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = dish_depth_cxt_bf2253_mipi_raw
CUSTOM_HAL_MAIN3_IMGSENSOR = dish_wide_cxt_gc5035_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = dish_main_txd_hi1634b_mipi_raw
CUSTOM_HAL_MAIN_LENS = dish_cn3927af
CUSTOM_HAL_MSENSORLIB = akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = dish_front_st_hi846_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = dish_main_txd_hi1634b_mipi_raw dish_front_st_hi846_mipi_raw dish_depth_cxt_bf2253_mipi_raw dish_wide_cxt_gc5035_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dish_cn3927af
CUSTOM_KERNEL_LINEARACCEL_SENSOR = yes
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_IMGSENSOR = dish_depth_cxt_bf2253_mipi_raw
CUSTOM_KERNEL_MAIN3_IMGSENSOR = dish_wide_cxt_gc5035_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = dish_main_txd_hi1634b_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dish_cn3927af
...
CUSTOM_KERNEL_SUB_IMGSENSOR = dish_front_st_hi846_mipi_raw
...
CUSTOM_MODEM=TK_MD_NLWCG_MP_6833_S98119AA1
...
MTK_AUDIO_AWINIC_SKT_SUPPORT = yes
...
#bug 625455, nishilin.wt, modify, 2021.3.15, camera bring up
...
# Bug609896,20200108,gudi.wt,Dual_charger func add
#+bug 625455, liyiying.wt, mod, 2021/03/12, charger bring up
...
#+Bug625455, yangxin.wt, ADD, 20210325, for Dish carrierConfig support
MTK_DYNAMIC_SBP_SUPPORT = yes
#-Bug625455, yangxin.wt, ADD, 20210325, for Dish carrierConfig support
MTK_EAP_SIM_AKA = yes
MTK_ECCCI_C2K = yes
#+EFUSE,mayuwu.wt,add,2021/1/19,ATO Version Config Fuse
ifeq ($(WT_COMPILE_FACTORY_VERSION), yes)
$(warning factory version config fuse)
MTK_EFUSE_WRITER_SUPPORT = yes
else
MTK_EFUSE_WRITER_SUPPORT = no
endif
#+Bug612865,tanghongnian.wt,modify,20210223,open embms support
...
#+CHK SC13486,mayuwu.wt,add,2020/12/22,ATO Version Removes Full Encryption
ifeq ($(WT_COMPILE_FACTORY_VERSION), yes)
...
#+Bug 651655, fangxianpeng.wt, modify, 20200426, modify for EngineerMode crash
...
#Bug 603477,huanghanchi.wt,modify,20201221,add for GMS apk
...
#Bug642663,xulei1.wt,20210421,MODIFY,VTS disable ppl agent
...
#Bug603459,add PE20 for charger bringup
#+bug 625455, liyiying.wt, mod, 2021/03/12, charger bring up
...
#+Bug640562, yangxin.wt, ADD, 20210325, for Dish RCS
MTK_RCS_SUPPORT = no
...
#bug 627008, weihang2.wt, modify, 20210427, modify for water drop curve
MTK_DISPLAY_CUTOUT_POLICY = 0
MTK_BLUETOOTH_AAC_VBR = no
MTK_SPK_AP_SWMIX_PROCESS = no
MTK_CAM_SINGLE_NR_SUPPORT = yes
#bug 618929,liuwentao.wt,20210111,add,user version build in MTKLogger
MSSI_MTK_LOG_CUSTOMER_SUPPORT = yes
MTK_TOUCHPANEL_KO =
MTK_FAST_CHARGER_TECH = no
BST_ALGO_SUPPORT = yes
#####-------WINGTECH--------#####
#+bug 622834, liwenbin.wt, modify,20210126, modify for property value
WT_INNER_VERSION=SW_S98119AA1_V078_M10_EF_DISH_JUPITER_USR_MP
#-bug 622834, liwenbin.wt, modify,20210126, modify for property value
WT_HARDWARE_VERSION = XXX
WT_CUSTOMER_NAME = XXX
WT_PRODUCTION_VERSION=WTCELERO5G_1.18.39
WT_PRODUCT_PROJECT = S98119AA1
WT_FEATURE_S98119AA1_CAMERA = yes
USE_SENSOR_MULTI_HAL=true
# add by xuli.wt for simlock
#SIM_ME_LOCK_MODE = 800
# add by xuli.wt for simlock

WT_PRODUCTION_ORI=V1.010_A01
#+Bug 612865,yuanwu1.wt.tmo.20201224,porting,[Wi-Fi calling using SIP-IMS Handset TRD]GID-MTRREQ-4970 V001 Wi-Fi calling Profiles. ~Start
# add by wangjiayu1.wt for OP08 apk
# change by xuli.wt for disable CXP
#+Bug625455, yangxin.wt, ADD, 20210325, for Dish carrierConfig support
MTK_CARRIEREXPRESS_PACK = na
#-Bug625455, yangxin.wt, ADD, 20210325, for Dish carrierConfig support
# change by xuli.wt for disable CXP
#-Bug 612865,yuanwu1.wt.tmo.20201224,porting,[Wi-Fi calling using SIP-IMS Handset TRD]GID-MTRREQ-4970 V001 Wi-Fi calling Profiles. ~End
#Bug 614086,fangxianpeng.wt.tmo.20201225,config the sar feature. start
SAR_TX_POWER_BACKOFF_SUPPORT = TRUE
#Bug 614086,fangxianpeng.wt.tmo.20201225,config the sar feature. end

#+Bug612027, cuiyingying.wt, ADD, 20210105, for TMO RCS
WT_TMO_RCS_SUPPORT = no
#-Bug612027, cuiyingying.wt, ADD, 20210105, for TMO RCS
#+Bug612865, xiongwei.wt, ADD, 20210208, for TMO OP
MTK_MD_SBP_CUSTOM_VALUE = 7
MTK_RTT_SUPPORT = yes
#-Bug612865, xiongwei.wt, ADD, 20210208, for TMO OP

#+Bug625453, yangxin.wt, ADD, 2021/3/9, add wt feature macro
WT_FEATURE_RSU_SUPPORT = yes
#-Bug625453, yangxin.wt, ADD, 2021/3/9, add wt feature macro
#+Bug643586, lianglei.wt, ADD, 2021/4/20, add for hidden menus
WT_FEATURE_HIDDEN_MENUS = yes
#-Bug643586, lianglei.wt, ADD, 2021/4/20, add for hidden menus
#+Bug640562, yangxin.wt, ADD, 20210325, for Dish RCS
MSSI_WT_TMO_RCS_SUPPORT = no
#-Bug640562, yangxin.wt, ADD, 20210325, for Dish RCS

#Bug671420, shaowenzhe.wt, ADD, 20210629, remove menu
